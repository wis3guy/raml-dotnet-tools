...
namespace Raml.Common
{
    ...
    {
        public static string BuildContent(string targetNamespace, string ramlOriginalSource, bool? useAsyncMethods, string clientRootClassName, bool? includeApiVersionInRoutePrefix)
        {
            ...
            if (includeApiVersionInRoutePrefix != null)
                content += string.Format("includeApiVersionInRoutePrefix: {0}{1}", includeApiVersionInRoutePrefix, Environment.NewLine);
        ...
        {
            var contents = BuildContent(props.Namespace, props.Source, props.ClientName, props.UseAsyncMethods, props.IncludeApiVersionInRoutePrefix);
            var fileInfo = new FileInfo(refFilePath) { IsReadOnly = false };
            File.WriteAllText(refFilePath, contents);
            fileInfo.IsReadOnly = true;
        }

        public static string BuildContent(string targetNamespace, string ramlOriginalSource, string clientName, bool? useAsyncMethods, bool? includeApiVersionInRoutePrefix)
        {
            var content = string.Format("// do not edit this file{0}source: {1}{0}namespace: {2}{0}",
                Environment.NewLine, ramlOriginalSource, targetNamespace);
