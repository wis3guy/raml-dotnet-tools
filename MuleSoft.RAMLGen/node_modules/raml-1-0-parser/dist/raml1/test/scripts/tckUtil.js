...
function doTestAPI(apiPath, extensions, tckJsonPath, newFormat, regenerteJSON, callTests, doAssert, expandLib) {
...
function generateMochaSuite(folderAbsPath, dstPath, dataRoot, mochaSuiteTitle, libExpand, newFormat) {
...
function dumpSuite(title, dataRoot, tests, libExpand, newFormat) {
    var dumpedTests = tests.map(function (x) { return dumpTest(x, dataRoot, libExpand, newFormat); });
    var testsStr = dumpedTests.join("\n\n");
    return "describe('" + title + "',function(){\n    \n" + testsStr + "\n    \n});";
}
function dumpTest(test, dataRoot, libExpand, newFormat) {
